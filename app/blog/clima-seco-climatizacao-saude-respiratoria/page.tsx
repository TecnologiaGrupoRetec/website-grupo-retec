              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#sub-0-o-que-o-ar-seco-provoca-no-corpo">O que o ar seco provoca no corpo</a>
                      </li>
                      <li>
                        <a href="#sub-1-como-a-climatizacao-atua-nesse-cenario">Como a climatização atua nesse cenário</a>
                      </li>
                      <li>
                        <a href="#sub-2-o-que-considerar-em-residências">O que considerar em residências</a>
                      </li>
                      <li>
                        <a href="#sub-3-o-que-considerar-em-ambientes-corporativos-e-hospitalares">O que considerar em ambientes corporativos e hospitalares</a>
                      </li>
                      <li>
                        <a href="#sub-4-pontos-praticos-para-a-temporada-seca">Pontos práticos para a temporada seca</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="sub-0-o-que-o-ar-seco-provoca-no-corpo" className={styles.subtitle}>O que o ar seco provoca no corpo</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-1-como-a-climatizacao-atua-nesse-cenario" className={styles.subtitle}>Como a climatização atua nesse cenário</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-2-o-que-considerar-em-residências" className={styles.subtitle}>O que considerar em residências</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-3-o-que-considerar-em-ambientes-corporativos-e-hospitalares" className={styles.subtitle}>O que considerar em ambientes corporativos e hospitalares</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-4-pontos-praticos-para-a-temporada-seca" className={styles.subtitle}>Pontos práticos para a temporada seca</h3>
                  <ul>
