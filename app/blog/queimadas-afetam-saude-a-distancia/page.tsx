              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#sub-0-como-fica-a-sua-saude">Como fica a sua saúde?</a>
                      </li>
                      <li>
                        <a href="#sub-1-quem-e-mais-vulneravel">Quem é mais vulnerável?</a>
                      </li>
                      <li>
                        <a href="#sub-2-solucoes-para-proteger-sua-saude">Soluções para proteger sua saúde</a>
                      </li>
                      <li>
                        <a href="#sub-3-o-ambiente-interno-e-seu-refugio">O ambiente interno é seu refúgio</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="sub-0-como-fica-a-sua-saude" className={styles.subtitle}>Como fica a sua saúde?</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-1-quem-e-mais-vulneravel" className={styles.subtitle}>Quem é mais vulnerável?</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-2-solucoes-para-proteger-sua-saude" className={styles.subtitle}>Soluções para proteger sua saúde</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-3-o-ambiente-interno-e-seu-refugio" className={styles.subtitle}>O ambiente interno é seu refúgio</h3>
                  <p className={styles.text}>
