              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#sub-0-o-que-afeta-o-desempenho-cognitivo">O que afeta o desempenho cognitivo</a>
                      </li>
                      <li>
                        <a href="#sub-1-o-peso-da-climatizacao-no-consumo-eletrico">O peso da climatização no consumo elétrico</a>
                      </li>
                      <li>
                        <a href="#sub-2-tecnologias-acessiveis-para-ganho-imediato">Tecnologias acessíveis para ganho imediato</a>
                      </li>
                      <li>
                        <a href="#sub-3-renovacao-de-ar-e-qualidade-percebida">Renovação de ar e qualidade percebida</a>
                      </li>
                      <li>
                        <a href="#sub-4-o-que-considerar-em-projetos-corporativos">O que considerar em projetos corporativos</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="sub-0-o-que-afeta-o-desempenho-cognitivo" className={styles.subtitle}>O que afeta o desempenho cognitivo</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-1-o-peso-da-climatizacao-no-consumo-eletrico" className={styles.subtitle}>O peso da climatização no consumo elétrico</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-2-tecnologias-acessiveis-para-ganho-imediato" className={styles.subtitle}>Tecnologias acessíveis para ganho imediato</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-3-renovacao-de-ar-e-qualidade-percebida" className={styles.subtitle}>Renovação de ar e qualidade percebida</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-4-o-que-considerar-em-projetos-corporativos" className={styles.subtitle}>O que considerar em projetos corporativos</h3>
                  <ul>
