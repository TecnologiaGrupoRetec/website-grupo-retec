        ...
        <main className={styles.articleContainer}>
          <section className={styles.article}>
            ...
            <article className={styles.content}>
              ...
              <Image className={styles.img} src="/blog/sistema-climatizacao-daikin.webp" alt="Sistema de Climatização Daikin" width="800" height="462" />
              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#sub-0-a-substituicao-dos-gases-refrigerantes">A substituição dos gases refrigerantes</a>
                      </li>
                      <li>
                        <a href="#sub-1-eficiência-energetica-em-edificios">Eficiência energética em edifícios</a>
                      </li>
                      <li>
                        <a href="#sub-2-automacao-e-controle-inteligente">Automação e controle inteligente</a>
                      </li>
                      <li>
                        <a href="#sub-3-manutencao-preventiva-e-pmoc">Manutenção preventiva e PMOC</a>
                      </li>
                      <li>
                        <a href="#sub-4-o-que-considerar-nas-decisoes-tecnicas">O que considerar nas decisões técnicas</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="sub-0-a-substituicao-dos-gases-refrigerantes" className={styles.subtitle}>A substituição dos gases refrigerantes</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-1-eficiência-energetica-em-edificios" className={styles.subtitle}>Eficiência energética em edifícios</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-2-automacao-e-controle-inteligente" className={styles.subtitle}>Automação e controle inteligente</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-3-manutencao-preventiva-e-pmoc" className={styles.subtitle}>Manutenção preventiva e PMOC</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-4-o-que-considerar-nas-decisoes-tecnicas" className={styles.subtitle}>O que considerar nas decisões técnicas</h3>
                  <ul>
