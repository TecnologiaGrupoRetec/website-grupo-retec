        ...
        <main className={styles.articleContainer}>
          <section className={styles.article}>
            ...
            <article className={styles.content}>
              ...
              <Image className={styles.img} src="/blog/doencas-respiratorias2.webp" alt="Climatizacao inteligente" width="800" height="462" />
              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#sub-0-por-que-o-ambiente-interno-entrou-na-equacao">Por que o ambiente interno entrou na equação</a>
                      </li>
                      <li>
                        <a href="#sub-1-o-que-a-climatizacao-inteligente-entrega">O que a climatização inteligente entrega</a>
                      </li>
                      <li>
                        <a href="#sub-2-aplicacoes-por-tipo-de-ambiente">Aplicações por tipo de ambiente</a>
                      </li>
                      <li>
                        <a href="#sub-3-o-que-considerar-nos-proximos-meses">O que considerar nos próximos meses</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="sub-0-por-que-o-ambiente-interno-entrou-na-equacao" className={styles.subtitle}>Por que o ambiente interno entrou na equação</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-1-o-que-a-climatizacao-inteligente-entrega" className={styles.subtitle}>O que a climatização inteligente entrega</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-2-aplicacoes-por-tipo-de-ambiente" className={styles.subtitle}>Aplicações por tipo de ambiente</h3>
                  <p className={styles.text}>
                  ...
                  <h3 id="sub-3-o-que-considerar-nos-proximos-meses" className={styles.subtitle}>O que considerar nos próximos meses</h3>
                  <ul>
