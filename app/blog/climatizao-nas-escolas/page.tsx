              ...
              <div className={styles.articleBodyRow}>
                ...
                <aside className={styles.tocSidebar}>
                  <div className={styles.tableOfContents}>
                    ...
                    <ul>
                      <li>
                        <a href="#impacto-aprendizado">Impacto direto no aprendizado</a>
                      </li>
                      <li>
                        <a href="#o-que-fazer">O que as escolas podem fazer</a>
                      </li>
                    </ul>
                  </div>
                </aside>
                ...
                <div className={styles.mainText}>
                  ...
                  <h3 id="impacto-aprendizado" className={styles.subtitle}>
                  ...
                  <p className={styles.text}>
                    Galletti lembra que um system de climatização adequado deve incluir trocadores de ar que garantam a renovação constante do ar ambiente. “Isso mantém a temperatura confortável e reduz os níveis de dióxido de carbono acumulado. Quando bem projetado, o sistema garante que o ar externo seja filtrado e tratado antes de ser introduzido, ajudando a prevenir a sonolência e a fadiga associadas à alta concentração de CO2”, aponta o especialista.
                  </p>
                  <h3 id="o-que-fazer" className={styles.subtitle}>
