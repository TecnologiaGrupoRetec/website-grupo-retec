...
/* 
  ...
  chamado `layout.tsx` na mesma pasta (`app/solucoes/grelhas/layout.tsx`) 
...
const produtos = [
  {
    ...
    imagem: "/solucoes/grelhas/grelha_trox_at_ag.png",
...

  {
    ...
    imagem: "/solucoes/grelhas/grelha_trox_ar_a.png",
...

  {
    ...
    imagem: "/solucoes/grelhas/grelha_trox_ar_ag.png",
...

  {
    ...
    imagem: "/solucoes/grelhas/grelha_trox_awk.png",
            ...
            <div className={styles.heroGrid}>
              <div className={styles.heroContent}>
                ...
                <div className={styles.heroActions}>
                  ...
                  {/* BOTÃO HERO ATUALIZADO PARA O MODAL */}
                  <button
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaCard}>
              ...
              {/* BOTÃO CTA ATUALIZADO PARA O MODAL */}
              <button
                onClick={() => setIsModalOpen(true)}
                type="button"
